...
public class MovieNewReleaseData implements Parcelable {
    ...
    public MovieNewReleaseData(JSONObject object) {
        try {
    ...
    protected MovieNewReleaseData(Parcel in) {
    ...
    public static final Creator<MovieNewReleaseData> CREATOR = new Creator<MovieNewReleaseData>() {
        @Override
        public MovieNewReleaseData createFromParcel(Parcel source) {
            return new MovieNewReleaseData(source);
        }

        @Override
        public MovieNewReleaseData[] newArray(int size) {
            return new MovieNewReleaseData[size];
        }
    };
}
